Feature: MW - 29 : ID Docs Page
  ...
  Scenario Outline: 
    ...
    And user clicks next button on the ID docs page
    And user checks if mandatory fields for Foreign Passport and Australian Passport Identification type
    ...
    And user clicks next button on the ID docs page
    And user checks if mandatory fields for Driver License and Medicare Identification type
  ...
  Scenario Outline: 
    ...
    And user adds autralian passport details
    And user clicks next button on the ID docs page
