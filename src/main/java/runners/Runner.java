...
@CucumberOptions(plugin = { "pretty", "html:target/htmlreports" }, // Reports to be produced.
	...
	tags = { "@Regression" }, // @WIP = Work in Progress. @Regression = For Repeating Testing. @RegressionFail = Comment this line for testing multiple feature files.
	...
	features = "src/test/resources/features/Sprint 2/MW - 104.feature" // Feature file to use for WIP.
