...
public class StepDefinitions extends Base {
	...
	@When("^user sees alert message saying \"([^\"]*)\" and clicks on \"([^\"]*)\"$")
	public void user_sees_alert_message_saying_and_clicks_on(String arg1, String arg2) throws Throwable {
		CommonFunctions.checkAlertMessageIsDisplayed(arg1);
		CommonFunctions.clickOnPopUp(arg2);
	}

	@Then("^user sees alert message saying \"([^\"]*)\"$")
	public void user_sees_alert_message_saying(String arg1) throws Throwable {
		CommonFunctions.checkAlertMessageIsDisplayed(arg1);
	}
